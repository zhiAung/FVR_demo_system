  ...
  <div class="main">
    <div class="part1">
      <div class="upload_image">
          <h3><font color="white">第二步：请上传图片</font></h3>
          <div class="upload">
      ...
      <!--输入表单-->
      <div class="input_id">
          <h3><font color="white">第一步：请输入ID</font></h3>
          <form action="" method="">
            <div>
      ...
      <div class="button">
        <button v-on:click="verification" type="submit">验证</button>
      </div>
      <div class="error">
        <p><font color="white">{{error}}</font></p>
      </div>
      <div class="result" v-if = "resultNumber === '0'">
      </div>
      <div class="result1" v-else-if = "resultNumber === '-1'">
        <p><font color="white">该ID不存在</font></p>
      </div>
      <div class="result2" v-else-if = "resultNumber === '-2'">
        <p><font color="white">验证失败</font></p>
      </div>
      <div class="result1" v-else>
        <p><font color="white">验证成功,欢迎用户：{{resultNumber}}</font></p>
      </div>
    </div>
  </div>
</template>
    ...
    methods: {
      ...
      verification: function() {
        if (this.my_id== "") {
          ...
          let url = 'http://10.108.246.53:5000/api/verification'
          let headers = {
...
<style scoped>
  ...
  .main {
    ...
    background-image:url('../assets/1044395137.jpg');
  }
</style>